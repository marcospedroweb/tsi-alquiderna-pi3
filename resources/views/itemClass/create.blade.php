...
@section('content')
    ...
    <form action="{{ route('itemClass.store') }}" class="row justify-content-center align-items-center" method="POST">
        @csrf
        <h3 class="text-center mb-3">Criando classe de item</h3>
        <div class="col-4 form-floating mb-3">
            <input type="text" class="form-control" placeholder="classe de item" name="name">
