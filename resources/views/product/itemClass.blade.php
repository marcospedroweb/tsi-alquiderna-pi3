    ...
    <div class="container-xxl">
        <div class="row mt-4">
            <div class="col-2 mt-4" id="div-filter-checkbox">
                <form method="GET" action="{{ URL::current() }}" class="sticky-top">
                    <h3 class="filter-title mb-3 fw-bold">Filtros</h3>
                    <div class="filter-option mt-4">
                        <h4 class="filter-subtitle">Nível mínimo</h4>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="filter[]" value="lvl-min-0" id="lvl-min-0"
                                {{ in_array('lvl-min-0', $checked) ? 'checked' : '' }}>
                            <label class="form-check-label" for="lvl-min-0">
                                Nível 0
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="filter[]" value="lvl-min-31"
                                id="lvl-min-31" {{ in_array('lvl-min-31', $checked) ? 'checked' : '' }}>
                            <label class="form-check-label" for="lvl-min-31">
                                Nível 31
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="filter[]" value="lvl-min-61"
                                id="lvl-min-61" {{ in_array('lvl-min-61', $checked) ? 'checked' : '' }}>
                    ...
                    <div class="filter-option mt-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="filter[]" value="new-true" id="new"
                                {{ in_array('new-true', $checked) ? 'checked' : '' }}>
                    ...
                    <div class="filter-option mt-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="filter[]" value="onSale-true" id="onSale"
                                {{ in_array('onSale-true', $checked) ? 'checked' : '' }}>
