...
@section('content')
    ...
    <section class="mb-6">
        <div class="big-banner-one-side-left row d-flex justify-content-center align-items-center mb-4 position-relative">
            <img src="https://via.placeholder.com/1296x624.png" alt="">
            <div
                class="col-6 position-absolute top-50 end-0 translate-middle-y row flex-column justify-content-center align-items-center">
                <div class="col-12 d-flex flex-column justify-content-center align-items-center">
                    <h2 class="big-banner-one-side-left-call">Texto chamativo do produto</h2>
                    <p class="big-banner-one-side-left-call-paragraph">Paragrafo do produto</p>
                </div>
                <div class="col-12 d-flex flex-column justify-content-center align-items-center">
                    <div class="big-banner-one-side-left-text d-flex flex-column justify-content-end">
                        <div class="d-flex flex-column">
                            <h3 style="word-wrap: break-word;" class="d-flex flex-column">
                                @if ($heavyArmor->new === 1)
                                    <span class="novidade">novo</span>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="card-product-price d-flex justify-content-center align-items-center">
                                <div class="d-flex flex-column align-items-end">
                                    @if ($heavyArmor->discount_price !== 0.0)
                                        <p class="text-decoration-line-through original-price">R$ <span
                                                class="product-price">{{ $heavyArmor->price }}</span></p>
            ...
            <div
                ...
                <div class="col-12 row justify-content-between align-items-center">
                    ...
                    <div class="col d-flex justify-content-end align-items-center big-banner-full-buy">
                        <p class="big-banner-full-price"></p>
                        <a href="{{ route('product.show', 1) }}" class="btn btn-primary">Ver produto</a>
                    </div>
                </div>
            </div>
        </div>
        <section class="row justify-content-between align-items-center mb-4">
            <div class="col-6">
                <div class="small-banner row justify-content-center align-items-center position-relative">
                    ...
                    <div
                        ...
                        <div class="big-banner-one-side-left-text w-100 h-100  d-flex flex-column justify-content-end">
                            <div class="d-flex flex-column">
                                <h3 style="word-wrap: break-word;" class="d-flex flex-column">
                                    @if ($heavyArmor->new === 1)
                                        <span class="novidade">novo</span>
