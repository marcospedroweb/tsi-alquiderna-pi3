...
@section('content')
    <div class="container-xxl mt-5 mb-6">
        <h2>Minha cesta</h2>
        @if (count($items) == 0)
            <div class="row justify-content-start align-items-start mt-3" id="cart-no-products">
                <div class="col-5">
                    <div class="bg-white p-2 rounded">
                        <h3 class="h3 m-0">Não há produtos na cesta</h3>
                    </div>
                </div>
            </div>
        @else
                                ...
                                <tr>
                                            ...
                                            <div class="ms-3">
                                                ...
                                                <div>
                                                    <a href="{{ route('cart.destroy', $item->id) }}"
                                                        class="btn btn-danger mt-3">Remover
                                                        produto</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <td class="div-product-units">
                                        <form action="{{ route('cart.update.unit', $item->id) }}" method="POST"
                                            class="d-flex justify-content-center align-items-center border mt-3 mx-3"
                                            id="units">
                                            @csrf
                                            @method('PUT')
                                            <div>
                                    ...
                                    <td class="div-product-price">
                                                    ...
                                                    <div class="modal-body" id="purchase-description-view">
                                                        <div class="row justify-content-center align-items-center">
                                                            <div class="col-4 my-3">
                                                                <div class="block-option text-center p-2">
                                                                    ...
                                                                    @else
                                                                        <p class="product-not-upgraded">Produto não
                                                                            encantado
                                                                        </p>
                                                                    @endif
                                                                </div>
                                                            ...
                                                            <div class="col-4 my-3">
                                                                <div class="block-option text-center p-2">
                                                                    ...
                                                                    @else
                                                                        <p class="product-not-upgraded">Garantia não
                                                                            adquirida
                                                                        </p>
                                                                    @endif
                                                                </div>
                                                            ...
                                                            <div class="col-4 my-3">
                                                                <div class="block-option text-center p-2">
                                                                    <h5 class="h5 model-title">Garantia de furto e roubo
                                                                    </h5>
                                                        ...
                                                        <div class="row justify-content-center align-items-center">
                                                            <div
                                                                ...
                                                                <h5 class="h5 m-0" id="purchase-total-title">Total
                                                                </h5>
                                                                <p class="m-0 fw-bold" id="purchase-total-price-preview">
                                                                    R$
                                                                    <span
                                        ...
                                        <!-- Modal edit-->
                                        <div class="modal fade" id="modal-edit-product-{{ $item->id }}"
                                            tabindex="-1" aria-labelledby="modal-edit-product-{{ $item->id }}-Label"
                                            aria-hidden="true">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="col-12">
                                                                        <select class="form-select" name="enchant"
                                                                            id="enchant-select" aria-label="encantar"
                                                                            required>
                                                                            ...
                                                                            <ul class="purchase-list-info"
                                                                                ...
                                                                                @else
                                                                                    <li class="{{ $item->enchant_physical_attack !== 0 ? '' : 'd-none' }}"
                                                                                        ...
                                                                                        físico</li>
                                                                                    <li class="{{ $item->enchant_magic_attack !== 0 ? '' : 'd-none' }}"
                                                                                        data-enchant-name="magic_attack">
                                                                                        Ataque
                                                                                        mágico
                                                                                    </li>
                                                                                    <li class="{{ $item->enchant_mana !== 0 ? '' : 'd-none' }}"
